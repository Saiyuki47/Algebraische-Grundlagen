...
export const uebungsblaetter: Uebungsblatt[] = [
  ...
  },
  {
    ...
    aufgaben: [
      { nr: '1a', text: 'Für welche $\\alpha \\in \\mathbb{R}$ hat $(G_1)$ keine/genau eine/unendlich viele Lösungen?', aufgabeId: 'b8_a1a' },
      { nr: '1b', text: 'Für welche $\\alpha \\in \\mathbb{R}$ hat $(G_2)$ keine/genau eine/unendlich viele Lösungen?', aufgabeId: 'b8_a1b' },
      { nr: '2a', text: 'Erweiterte Koeffizientenmatrix angeben und über die Determinante prüfen, ob (a) eindeutig lösbar ist.', aufgabeId: 'b8_a2a' },
      { nr: '2b', text: 'Erweiterte Koeffizientenmatrix angeben und über die Determinante prüfen, ob (b) eindeutig lösbar ist.', aufgabeId: 'b8_a2b' },
      { nr: '2c', text: 'Erweiterte Koeffizientenmatrix angeben und über die Determinante prüfen, ob (c) eindeutig lösbar ist.', aufgabeId: 'b8_a2c' },
      { nr: '3a', text: 'Bestimmen Sie $\\det A$ für $A = \\begin{pmatrix} 3 & 5 \\\\ 9 & -3 \\end{pmatrix}$.', aufgabeId: 'b8_a3a' },
      { nr: '3b', text: 'Bestimmen Sie $\\det B$ für die 3×3-Matrix $B$.', aufgabeId: 'b8_a3b' },
      { nr: '3c', text: 'Bestimmen Sie $\\det C$ für die 4×4-Matrix $C$.', aufgabeId: 'b8_a3c' },
      { nr: '4a', text: 'Bestimmen Sie $\\det \\tilde{A}$ mit den Rechenregeln (aus $\\det A$). Kein Laplace!', aufgabeId: 'b8_a4a' },
      { nr: '4b', text: 'Bestimmen Sie $\\det \\tilde{B}$ mit den Rechenregeln (aus $\\det B$). Kein Laplace!', aufgabeId: 'b8_a4b' },
      { nr: '4c', text: 'Bestimmen Sie $\\det \\tilde{C}$ mit den Rechenregeln (aus $\\det C$). Kein Laplace!', aufgabeId: 'b8_a4c' },
      { nr: '5a', text: 'Determinante von $A$ (5×5, alle Einträge $-1$) über Zeilenstufenform.', aufgabeId: 'b8_a5a' },
      { nr: '5b', text: 'Determinante von $B$ (4×4) über Zeilenstufenform.', aufgabeId: 'b8_a5b' },
      { nr: '5c', text: 'Determinante von $C$ (3×3) über Zeilenstufenform.', aufgabeId: 'b8_a5c' },
      { nr: '6a', text: 'Wenn noch Zeit ist: Für welche $\\alpha$ hat das homogene LGS keine Lösung? (Determinante)', aufgabeId: 'b8_a6a' },
      { nr: '6b', text: 'Wenn noch Zeit ist: Für welche $\\alpha$ hat das homogene LGS genau eine Lösung? (Determinante)', aufgabeId: 'b8_a6b' },
      { nr: '6c', text: 'Wenn noch Zeit ist: Für welche $\\alpha$ hat das homogene LGS unendlich viele Lösungen? (Determinante)', aufgabeId: 'b8_a6c' },
    ],
  },
  {
    id: 'blatt9',
    ...
    aufgaben: [
      { nr: '1a', text: 'Skizzieren Sie $U_1 = \\{(x_1,x_2) : x_1 \\geq 0, x_2 \\geq 0\\}$. Untervektorraum?', aufgabeId: 'b9_a1a' },
      { nr: '1b', text: 'Skizzieren Sie $U_2 = \\{(x_1,x_2) : 3x_1 = 2x_2\\}$. Untervektorraum?', aufgabeId: 'b9_a1b' },
      { nr: '1c', text: 'Skizzieren Sie $U_3 = \\{(x_1,x_2) : x_1 x_2 = 0\\}$. Untervektorraum?', aufgabeId: 'b9_a1c' },
      { nr: '1d', text: 'Skizzieren Sie $U_4 = \\{(x_1,x_2) : |x_1| \\leq |x_2|\\}$. Untervektorraum?', aufgabeId: 'b9_a1d' },
      { nr: 2, text: 'Zeigen Sie, dass $E = \\{x \\in \\mathbb{R}^3 : 2x_1 + 3x_2 - x_3 = 0\\}$ ein UVR ist. Lineare Hülle, Basis, Dimension?', aufgabeId: 'b9_a2' },
      { nr: '3a', text: 'Lineare Hülle: $\\mathrm{lin}\\{e_1, e_2\\} = \\mathrm{lin}\\{(1,1,0)\\}$ – richtig?', aufgabeId: 'b9_a3a' },
      { nr: '3b', text: 'Lineare Hülle: $\\mathrm{lin}\\{0\\} = \\{0\\}$ – richtig?', aufgabeId: 'b9_a3b' },
      { nr: '3c', text: 'Lineare Hülle: $\\mathrm{lin}\\{(1,0,0),(-1,0,0)\\} = \\{(x_1,0,0)\\}$ – richtig?', aufgabeId: 'b9_a3c' },
      { nr: '3d', text: 'Lineare Hülle: drei Achsenvektoren spannen $\\mathbb{R}^3$ auf – richtig?', aufgabeId: 'b9_a3d' },
      { nr: '4(i)', text: 'Lineare Unabhängigkeit prüfen (i): vier Vektoren im $\\mathbb{R}^4$.', aufgabeId: 'b9_a4i' },
      { nr: '4(ii)', text: 'Lineare Unabhängigkeit prüfen (ii): zwei Vektoren.', aufgabeId: 'b9_a4ii' },
      { nr: '4(iii)', text: 'Lineare Unabhängigkeit prüfen (iii): ein Vektor.', aufgabeId: 'b9_a4iii' },
      { nr: '4(iv)', text: 'Lineare Unabhängigkeit prüfen (iv): drei Vektoren im $\\mathbb{R}^3$.', aufgabeId: 'b9_a4iv' },
      { nr: '4(v)', text: 'Lineare Unabhängigkeit prüfen (v): drei Vektoren im $\\mathbb{R}^3$.', aufgabeId: 'b9_a4v' },
      { nr: '4(vi)', text: 'Lineare Unabhängigkeit prüfen (vi): der Nullvektor.', aufgabeId: 'b9_a4vi' },
      { nr: 5, text: 'Wenn noch Zeit ist: Für welche $t \\in \\mathbb{R}$ sind $v_1, v_2, v_3$ linear unabhängig?', aufgabeId: 'b9_a5' },
      { nr: '6a', text: 'Wenn noch Zeit ist: Ist die Menge aus 3 Vektoren eine Basis von $\\mathbb{R}^4$?', aufgabeId: 'b9_a6a' },
      { nr: '6b', text: 'Wenn noch Zeit ist: Ist die Menge aus 4 Vektoren eine Basis von $\\mathbb{R}^3$?', aufgabeId: 'b9_a6b' },
    ],
  },
]
